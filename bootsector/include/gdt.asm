; GDT
; Ref
;wiki.osdev.org/global_descriptor_table
;wiki.osdev.org/gdt_tutorial (using C)
;intel manual 325462 https://www.intel.com/content/dam/www/public/us/en/documents/manuals/64-ia-32-architectures-software-developer-vol-3a-part-1-manual.pdf
